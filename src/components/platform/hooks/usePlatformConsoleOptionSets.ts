...
export function usePlatformConsoleOptionSets<TExportJob extends { status: string }>({
  ...
  const supportScopeOptions = useMemo(
    () => [
      ...
      { value: 'customers', label: t('supportScopeCustomers') },
      { value: 'expenses', label: t('supportScopeExpenses') },
      { value: 'reports', label: t('supportScopeReports') },
      { value: 'audit', label: t('supportScopeAudit') },
      { value: 'approvals', label: t('supportScopeApprovals') },
      { value: 'notes', label: t('supportScopeNotes') },
      { value: 'attachments', label: t('supportScopeAttachments') },
      ...
      { value: 'search', label: t('supportScopeSearch') },
    ],
    [t],
  );
